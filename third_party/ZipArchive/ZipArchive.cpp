...
// is Copyrighted 2000 - 2015 by Artpol Software - Tadeusz Dracz
//
...
const char CZipArchive::m_gszCopyright[] = {"The ZipArchive Library Copyright (c) 2000 - 2015 Artpol Software - Tadeusz Dracz"};
const char CZipArchive::m_gszVersion[] = {"4.6.2"};
